...
plt.legend()
plt.savefig('./results/l2/cnn/Train_perf_cnn_' + str(dim) + '_l2.png', dpi=100)	#save image
...
def plot_confusion_matrix(cm, title='Confusion matrix', cmap=plt.cm.Blues, labels=[]):
    ...
    plt.savefig('./results/l2/cnn/conf_mat_' + str(dim) + '_l2.png', dpi=100)	#save image    
...
print(acc)
with open('./results/l2/cnn/results_cnn_10b_' + str(dim) + '_l2.pkl','wb') as fd:
    pickle.dump( acc , fd )
...
plt.title("CNN Classification Accuracy - L2 PCA"+ str(Fraction(dim/256)))
plt.savefig('./results/l2/cnn/Acc_curve_' + str(dim) + '_l2.png', dpi=100)	#save image
